...
const CONVERTERS = {
  ...
  'jpg-to-png': {
    title: 'Convert JPG to PNG Online - Lossless Transparent Converter | Pixiva',
    description: 'Convert JPG images to transparent, lossless PNG format locally in your web browser. 100% private, free, batch conversion supported.',
    keywords: 'jpg to png, convert jpg to png, free jpg to png converter, batch jpg to png, offline image converter',
    inputName: 'JPG',
    outputName: 'PNG',
    accept: '.jpg,.jpeg',
    targetValue: 'png',
    inputFormatLabel: 'JPG format',
    heroTitle: 'Convert JPG to PNG',
    heroSubtitle: 'Rasterize lossy JPG images into high-quality transparent PNG format locally in browser memory. 100% private.',
    seoTitle: 'Everything about converting JPG to PNG',
    seoIntro: 'JPG is a lossy compression format, while PNG is a lossless format that supports transparency. Converting your JPG photos to PNG makes them ideal for editing, web design layers, or further compression without further quality loss.',
    faq1Q: 'Will converting JPG to PNG preserve transparency?',
    faq1A: 'JPG images do not support transparency. However, converting JPG to PNG will output a high-quality, lossless PNG image, allowing you to edit and add transparency/alpha channels later.',
    faq2Q: 'Does converting JPG to PNG increase quality?',
    faq2A: 'JPG is a lossy format. Converting it to PNG makes it lossless for future edits (preventing further quality degradation), but it cannot restore details already lost in the original JPG compression.'
  },
  'png-to-jpg': {
    title: 'Convert PNG to JPG Online - Highly Compressed Images | Pixiva',
    description: 'Convert transparent PNG images to highly-compressed JPG format locally in your web browser. 100% private, free, batch conversion supported.',
    keywords: 'png to jpg, convert png to jpg, free png to jpg converter, batch png to jpg, offline image converter',
    inputName: 'PNG',
    outputName: 'JPG',
    accept: '.png',
    targetValue: 'jpeg',
    inputFormatLabel: 'PNG format',
    heroTitle: 'Convert PNG to JPG',
    heroSubtitle: 'Compress lossless PNG files into lightweight, universally compatible JPG images locally in browser memory.',
    seoTitle: 'Everything about converting PNG to JPG',
    seoIntro: 'PNG is built for high-detail, transparent image preservation, but leads to massive file sizes. JPG provides great compression ratios that load fast on standard web browsers. Converting your PNGs to JPG cuts loading times significantly.',
    faq1Q: 'What happens to the transparent background when converting PNG to JPG?',
    faq1A: 'Since JPG does not support transparency, transparent areas will automatically render as a clean white background.',
    faq2Q: 'Why should I convert PNG to JPG?',
    faq2A: 'PNG files are lossless and often have large file sizes. Converting them to JPG significantly reduces file size, making them ideal for web pages, emails, and storage.'
  },
  'webp-to-jpg': {
    title: 'Convert WebP to JPG Online - Universal Image Compatibility | Pixiva',
    description: 'Convert WebP files into universally-compatible JPEGs locally in your web browser. 100% private, free, batch conversion supported.',
    keywords: 'webp to jpg, convert webp to jpg, free webp to jpg converter, batch webp to jpg, offline image converter',
    inputName: 'WebP',
    outputName: 'JPG',
    accept: '.webp',
    targetValue: 'jpeg',
    inputFormatLabel: 'WebP format',
    heroTitle: 'Convert WebP to JPG',
    heroSubtitle: 'Export modern WebP graphics to standard JPG formats locally in browser memory with zero file uploads.',
    seoTitle: 'Everything about converting WebP to JPG',
    seoIntro: 'WebP is highly optimized for website pages, but lacks native previews in some legacy desktops, email platforms, and applications. Converting WebP to JPG guarantees your graphic files load everywhere.',
    faq1Q: 'Does converting WebP to JPG reduce visual quality?',
    faq1A: 'Both formats use compression. If you convert WebP to JPG at a high quality setting (like 80% or 90%), the visual difference is virtually imperceptible.',
    faq2Q: 'Can I convert WebP files in batch?',
    faq2A: 'Yes! Pixiva\'s batch queue allows you to upload multiple WebP files and convert/download them all as JPGs simultaneously.'
  }
};
